         ...
         "${var.product_name}" = [
            {
               ...
               to_port                  = 22
               protocol                 = "tcp"
               description              = "PINGIDM internal control ingress SSH"
            ...
            },
            {
               ...
               to_port                  = 8080
               protocol                 = "tcp"
               description              = "PINGIDM ingress 8080"
            ...
            },
            {
               ...
               to_port                  = 8443
               protocol                 = "tcp"
               description              = "PINGIDM ingress 8443"
               cidr_blocks              = var.cidr_blocks[var.products[var.product_name].subnet]
            },
            {
               from_port                = 8444
               to_port                  = 8444
               protocol                 = "tcp"
               description              = "PINGIDM ingress 8444"
               cidr_blocks              = var.cidr_blocks[var.products[var.product_name].subnet]
            }
         ]
         ...
         "${var.product_name}" = [
            {
               ...
               to_port                  = 80
               protocol                 = "tcp"
               description              = "PINGIDM egress HTTP"
            ...
            },
            {
               ...
               to_port                  = 8080
               protocol                 = "tcp"
               description              = "PINGIDM egress 8080"
               cidr_blocks              = var.cidr_blocks[var.products[var.product_name].subnet]
            },
            {
               from_port                = 8443
               to_port                  = 8443
               protocol                 = "tcp"
               description              = "PINGIDM egress 8443"
               cidr_blocks              = ["0.0.0.0/0"]
            },
            {
               from_port                = 8444
               to_port                  = 8444
               protocol                 = "tcp"
               description              = "PINGIDM egress 8444"
               cidr_blocks              = ["0.0.0.0/0"]
            }
         ]
      }
