      ...
      "ingress" = {
         ...
         "${var.product_name}" = [
            ...
            },
            {
               ...
               to_port                  = 5986
               protocol                 = "tcp"
               description              = "Cyberark ingress 5986"
               cidr_blocks              = var.internet_control_access
            },
            {
               from_port                = 443
         ...
         "${var.product_name}" = [
            {
               ...
               to_port                  = 3389
               protocol                 = "tcp"
               description              = "Cyberark external egress RDP"
            ...
            },
            {
               ...
               to_port                  = 80
               protocol                 = "tcp"
               description              = "Cyberark egress HTTP"
               cidr_blocks              = ["0.0.0.0/0"]
            },
            {
               from_port                = 443
               to_port                  = 443
               protocol                 = "tcp"
               description              = "Cyberark external egress HTTPS"
               cidr_blocks              = ["0.0.0.0/0"]
            },
            {
               from_port                = 1858
               to_port                  = 1858
               protocol                 = "tcp"
               description              = "Cyberark external egress 1858"
               cidr_blocks              = ["0.0.0.0/0"]
            }
         ]
      }
